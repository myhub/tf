from nlp_count import NlpCount
...
parser.add_argument("--ckpt", type=str, default="ckpt_count.pth")
...
train_dataset = NlpCount(is_training=True)
...
test_dataset = train_dataset = NlpCount(is_training=False)
