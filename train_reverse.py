from nlp_reverse import NlpReverse
...
parser.add_argument("--ckpt", type=str, default="ckpt_reverse.pth")
...
train_dataset = NlpReverse(seq_len=seq_len, align_left=align_left)
...
class Net(nn.Module): 
    def __init__(self, nc):
        ...
        self.mlp = nn.Linear(nc,len(train_dataset.alphabet), bias=True)
...
test_dataset = NlpReverse(seq_len=seq_len, align_left=align_left, is_training=False)
